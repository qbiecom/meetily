...
impl ParakeetEngine {
    ...
    pub async fn discover_models(&self) -> Result<Vec<ModelInfo>> {
        ...
        let model_configs = [
            ...
            (
                ...
                670,
                QuantizationType::Int8,
                "Ultra Fast (v3 SmoothQuant)",
                "Community SmoothQuant int8 variant based on Parakeet TDT 0.6B v3",
            ),
            (
                ...
                "Fast (v3)",
                "Full precision v3 model with higher memory and disk requirements",
            ),
            (
                ...
                QuantizationType::Int8,
                "Fast (pt-BR)",
                "Brazilian Portuguese TAGARELA int8 model tuned for pt-BR transcription",
            ),
            (
                ...
                QuantizationType::FP32,
                "Fast (pt-BR FP32)",
                "Full precision Brazilian Portuguese TAGARELA model tuned for pt-BR transcription",
            ),
            (
    ...
    pub async fn delete_model(&self, model_name: &str) -> Result<String> {
        ...
        match &model_info.status {
            ModelStatus::Corrupted { .. } | ModelStatus::Available => {
                ...
                Ok(format!(
                    "Successfully deleted Parakeet model '{}'",
                    model_name
                ))
            }
            _ => Err(anyhow!(
    ...
    pub async fn download_model_detailed(
        ...
        let file_sizes: std::collections::HashMap<&str, u64> = match model_info.quantization {
            ...
            QuantizationType::FP32 => {
                // FP32 model sizes (encoder uses external data file)
                [
