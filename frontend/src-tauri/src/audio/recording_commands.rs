        ...
        let listener_id = app.listen("transcript-update", move |event: tauri::Event| {
            ...
            if let Ok(update) = serde_json::from_str::<TranscriptUpdate>(event.payload()) {
                ...
                let segment = crate::audio::recording_saver::TranscriptSegment {
                    ...
                    attribution_source: Some(update.attribution_source.clone()),
                    overlap_region_id: update.overlap_region_id.clone(),
                    overlap_speaker_ids: update.overlap_speaker_ids.clone(),
                    ...
                    overlap_status: update.overlap_status.clone(),
                };
