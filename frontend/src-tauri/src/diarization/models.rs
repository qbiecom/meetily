...
pub const EMBEDDING_MODELS: &[EmbeddingModelInfo] = &[
    ...
    EmbeddingModelInfo {
        id: "3dspeaker-eres2net-large-zh",
        name: "3D-Speaker ERes2Net Large",
        description: "Higher-accuracy 3D-Speaker ERes2Net Large embedding model; slower but stronger for imported files.",
    ...
    EmbeddingModelInfo {
        id: "3dspeaker-eres2netv2-zh",
        name: "3D-Speaker ERes2NetV2",
        description: "Newer 3D-Speaker ERes2NetV2 embedding model; good accuracy/speed tradeoff for imported files.",
